...
ps = M5Label('Text', x=19, y=217, color=0x30b719, font=FONT_MONT_14, parent=None)
HttpStatus = M5Label('Text', x=249, y=217, color=0x30b719, font=FONT_MONT_14, parent=None)
